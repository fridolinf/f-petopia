...
class DashboardAdmin extends Component {
	...
	render() {
		const { successTransaction, allUser, allMarkets } = this.props;
		return (
			<div>
				<UIBlocker
				...
				<Row justify='center'>
					<Card.Grid
						...
						className='mr-4 mb-3 text-center'
					>
						<Descriptions
					...
					>
						...
						>
							<Descriptions.Item>
								<p style={{ fontSize: '2em', fontWeight: 'bold' }}>{allUser}</p>
							</Descriptions.Item>
						</Descriptions>
					</Card.Grid>
					<Card.Grid
...
const mapStateToProps = (state) => {
	...
	return { successTransaction, allMarkets, allUser, totalT, loading, error };
};
